...
(function (blink) {
	...
	var parcoursStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	parcoursStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_parcours',
		ckEditorStyles: {
			name: 'parcours',
			styles: [
				...
				{ name: 'Caja Bordes amarillos', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-box-8' } },
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'parcours-navbar'),
	...
	parcoursStyle.prototype = _.extend({}, new blink.theme.styles.basic(), parcoursStyle.prototype);

	blink.theme.styles['parcours'] = parcoursStyle;
